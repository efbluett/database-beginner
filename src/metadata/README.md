 ...
 * [dbeginner.yml](dbeginner.yml)
     * Determines how your purl.obolibrary.org/obo/dbeginner/ redirects will be handled
     ...
     * Paste in the contents of [dbeginner.yml](dbeginner.yml)
 ...
 * [dbeginner.md](dbeginner.md)
     ...
     * Paste in the contents of [dbeginner.md](dbeginner.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
